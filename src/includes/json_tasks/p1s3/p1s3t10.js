...
function removeUserFromCluster(user_uid, cluster_uid) {
  return new Promise(function (resolve, reject) {
    var return_msg = "";
    var debug_data = [];
    var call_result = {};
    var task_id = "p1s3t10RemoveUserFromCluster";
    var response_data = {};
    ...
    ajax({
      url: window.G_ajax_test_domain + '/s3/p1s3t10-remove-user-from-cluster',
      method: 'POST',
      data: {
        'p1s3t10_user_uid': user_uid,
        'p1s3t10_cluster_uid': cluster_uid,
      },
      ...
      error: function (result) {
        return_msg += "failed to remove user from cluster, error data:" + JSON.stringify(result);
...
export default removeUserFromCluster