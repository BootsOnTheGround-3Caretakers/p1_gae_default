...
function assignUserHashtag(firebase_email, firebase_token, user_uid, hashtag_uid) {
  return new Promise(function (resolve, reject) {
    var return_msg = "";
    var debug_data = [];
    var call_result = {};
    var task_id = "p1s3t13assignUserHashtag";
    var response_data = {};
    ...
    ajax({
      url: 'https://p1s3-web-requests-dot-aqueous-choir-160420.appspot.com/p1s3t13-assign-user-hashtag',
      method: 'POST',
      data: {
        'p1s3_firebase_email': firebase_email,
        'p1s3_token': firebase_token,
        'p1s3t13_user_uid': user_uid,
        'p1s3t13_hashtag_uid': hashtag_uid
      },
      ...
      error: function (result) {
        return_msg += "failed to assign hashtag to a user, error data:" + JSON.stringify(result);
...
export default assignUserHashtag