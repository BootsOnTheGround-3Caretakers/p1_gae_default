...
function modifyUserInformation(firebase_email, firebase_token, user_information) {
  return new Promise(function (resolve, reject) {
    ...
    var optional_keys = [
      ...
      'home_address', 'country_uid', 'region_uid', 
    ...
    if ('email_address' in user_information === true && user_information['email_address'] !== undefined) {
    ...
    var data = {};
    data['p1s3_firebase_email'] = firebase_email;
    data['p1s3_token'] = firebase_token;
    ...
    ajax({
      url: 'https://p1s3-web-requests-dot-aqueous-choir-160420.appspot.com/p1s3t4-modify-user-information',
      method: 'POST',
      data: data,
