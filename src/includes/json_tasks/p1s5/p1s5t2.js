...
function getClusterData(firebase_email, firebase_token, cluster_uids, phone_number, user_uid) {
  return new Promise(function (resolve, reject) {
    var return_msg = "";
    var debug_data = [];
    var call_result = {};
    var task_id = "p1s5t2GetClusterData";
    var response_data = {};
    ...
    debug_data.push(call_result);
    call_result = bi1_data_validation.is_array(cluster_uids);
    debug_data.push(call_result);
    ...
    ajax({
      url: "https://p1s5-web-requests-dot-aqueous-choir-160420.appspot.com/p1s5t2-get-cluster-data",
      method: 'POST',
      data: {
        'p1s5_firebase_email': firebase_email,
        'p1s5_token': firebase_token,
        'p1s5t2_phone_number': phone_number,
        'p1s5t2_cluster_uids': cluster_uids,
        'p1s5t2_user_uid': user_uid,
      },
